...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!token) {
      setError("Token invalide. Veuillez refaire une demande de réinitialisation.");
      return;
    }
        ...
        <div className="relative z-10 bg-white/85 backdrop-blur-xl w-full max-w-md rounded-3xl login-card px-8 py-8 border border-white/70">
          {success ? (
            <div className="text-center py-6">
              ...
              <h2 className="text-2xl font-bold text-slate-800 mb-2">Succès !</h2>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="text-center">
                <Link
                  to="/login"
                  className="text-slate-600 hover:text-blue-600 font-medium text-sm transition"
                >
